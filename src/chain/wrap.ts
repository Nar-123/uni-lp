...
export const GAS_RESERVE_WEI: Record<SupportedChainId, bigint> = {
  4663: 500_000_000_000_000n, // 0.0005 ETH
  56: 1_000_000_000_000_000n, // 0.001 BNB
  8453: 500_000_000_000_000n, // 0.0005 ETH
};
...
export async function getEffectiveDepositBalance(
  ...
  if (!isWrapped) {
    return { erc20, native: 0n, wrappable: 0n, effective: erc20, isWrapped: false };
  }
...
export { resolveReceivedAmount } from './safety.js';
...
export async function unwrapNative(
  ...
  if (amount <= 0n) throw new Error('Unwrap amount must be > 0');
